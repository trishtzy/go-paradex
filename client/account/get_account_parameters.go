...
// WithSubaccountAddress adds the subaccountAddress to the get account params
func (o *GetAccountParams) WithSubaccountAddress(subaccountAddress *string) *GetAccountParams {
	o.SetSubaccountAddress(subaccountAddress)
	return o
}

// SetSubaccountAddress adds the subaccountAddress to the get account params
func (o *GetAccountParams) SetSubaccountAddress(subaccountAddress *string) {
	o.SubaccountAddress = subaccountAddress
}
...
func (o *GetAccountParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.SubaccountAddress != nil {

		// query param subaccount_address
		var qrSubaccountAddress string

		if o.SubaccountAddress != nil {
			qrSubaccountAddress = *o.SubaccountAddress
		}
		qSubaccountAddress := qrSubaccountAddress
		if qSubaccountAddress != "" {

			if err := r.SetQueryParam("subaccount_address", qSubaccountAddress); err != nil {
				return err
			}
		}
	}
